...
logger = logging.getLogger("ESP logger")
...
# %%
def get_parameters():
    parser = argparse.ArgumentParser(description="ESP for prediction")
    parser.add_argument('--target', type=int, default=7, metavar='N',
                        help='target domain number. 0 to 7.')
    parser.add_argument("--output", type=str,
                        default='output/ESP_output.csv', help="output file")
...
logger.info("Test mae loss: {:.4e}".format((test_loss_mae)))
